...
export class DataManipulator {
  static generateRow(serverResponds: ServerRespond[]) {
    ...
    return {
      ...
      // trigger an alert when the ratio is beyond the bounds
      trigger_alert:
